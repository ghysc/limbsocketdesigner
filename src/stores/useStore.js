...
const useStore = create((set) => ({
  ...
  // Update grid cell
  setGridCell: (gridType, row, col, value) => set((state) => {
  ...
  // Update primitive
  updatePrimitive: (id, updates) => set((state) => ({
  ...
  // Delete primitive
  deletePrimitive: (id) => set((state) => ({
    primitives: state.primitives.filter(p => p.id !== id),
    selectedPrimitiveId: state.selectedPrimitiveId === id ? null : state.selectedPrimitiveId
  })),
